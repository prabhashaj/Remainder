...
async function testLimits() {
  ...
  dbMod.fetchSubscription = async () => ({
    id: "1", user_id: "1", tier: "weekly", status: "active",
    razorpay_customer_id: null, razorpay_subscription_id: null,
    plan_id: null, current_period_end: null, trial_ends_at: null,
  ...
  dbMod.fetchSubscription = async () => ({
    id: "1", user_id: "1", tier: "free", status: "trialing",
    razorpay_customer_id: null, razorpay_subscription_id: null,
    plan_id: null, current_period_end: null, trial_ends_at: new Date(Date.now() + 86400000).toISOString(),
    created_at: "", updated_at: ""
  });
